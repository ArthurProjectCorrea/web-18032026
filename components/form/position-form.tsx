...
import { Plus, X, Shield, Settings2, Info, ChevronLeft } from 'lucide-react';
    ...
    const fetchInitialData = async () => {
      try {
        ...
        const [depts, scrs, perms] = await Promise.all([
          ...
          fetchApi<{ id: number; name: string }[]>('/api/permissions'),
        ]);
    ...
    <form onSubmit={handleSubmit} className="flex w-full flex-col gap-8">
          ...
          <CardContent className="grid grid-cols-1 gap-6 pt-6 md:grid-cols-2">
            ...
            <Field>
              ...
              <Select
                ...
                disabled={isLoading}
              >
                <SelectTrigger className="bg-background focus:ring-primary/20 w-full">
      ...
      <section className="space-y-4">
        <Card className="border-primary/10 shadow-sm">
          <CardHeader className="bg-muted/30 border-b pb-4">
            ...
            <CardDescription>
              Defina quais telas e ações este cargo está autorizado a realizar.
            </CardDescription>
          </CardHeader>
      ...
      <div className="mt-10 flex items-center justify-end gap-4 border-t pt-8">
        ...
        <Button
          type="submit"
          disabled={isLoading}
          className="px-12 font-bold shadow-sm"
        >
          {isLoading ? (
